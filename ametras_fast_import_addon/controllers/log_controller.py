...
class LogController(http.Controller):
    ...
    @http.route('/ametras_fast_import/log/save', type='json', auth='user',
                methods=['POST'])
    def save_log(self, **kwargs):
        ...
        vals = {
            ...
            'started_at': _parse_datetime(kwargs.get('started_at')) or fields.Datetime.now(),
            'finished_at': _parse_datetime(kwargs.get('finished_at')) or fields.Datetime.now(),
    ...
    @http.route('/ametras_fast_import/log/create', type='json', auth='user',
                methods=['POST'])
    ...
    @http.route('/ametras_fast_import/log/update', type='json', auth='user',
                methods=['POST'])
    ...
    @http.route('/ametras_fast_import/log/finalize', type='json', auth='user',
                methods=['POST'])
    ...
    @http.route('/ametras_fast_import/log/get', type='json', auth='user',
                methods=['POST'])
    ...
    @http.route('/ametras_fast_import/log/list', type='json', auth='user',
                methods=['POST'])
    ...
    @http.route('/ametras_fast_import/log/<int:log_id>/error_csv', type='http',
    ...
    def download_error_csv(self, log_id, **kwargs):
        ...
        return request.make_response(
            ...
            headers=[
                ...
                ('Content-Disposition', f'attachment; filename="import_errors_{log_id}.csv"'),
            ],
        )
