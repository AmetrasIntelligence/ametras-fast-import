...
class TestParseRefs(unittest.TestCase):
    ...
    def test_real_route_ids(self):
        ...
        result = _parse_refs('purchase_stock.route_warehouse0_buy,stock.route_warehouse0_mto')
...
class TestLookupRef(unittest.TestCase):
    ...
    def test_found(self):
        ...
        ref_map = {
            ('product.category', '__import__', 'product_category#123'): 42
        }
    ...
    def test_with_module(self):
        ...
        ref_map = {
            ('stock.route', 'purchase_stock', 'route_warehouse0_buy'): 7
        }
        result = _lookup_ref('stock.route', 'purchase_stock.route_warehouse0_buy', ref_map)
